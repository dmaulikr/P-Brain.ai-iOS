...
//    self.wrapper.layer.masksToBounds = YES;
    ...
    UIBezierPath* rounded = [UIBezierPath bezierPathWithRoundedRect:self.wrapper.bounds byRoundingCorners:UIRectCornerTopLeft|UIRectCornerBottomLeft|UIRectCornerTopRight cornerRadii:CGSizeMake(10.0, 10.0)];
